...
#if VERSION_CN
INCLUDE_ASM("asm/cn/nonmatchings/main_segment/replay", replay_record_init_buffer);
#endif
...
#if VERSION_CN
INCLUDE_ASM("asm/cn/nonmatchings/main_segment/replay", replay_record_init);
#endif
...
#if VERSION_CN
INCLUDE_ASM("asm/cn/nonmatchings/main_segment/replay", replay_record);
#endif
...
#if VERSION_CN
INCLUDE_ASM("asm/cn/nonmatchings/main_segment/replay", replay_play_init);
#endif
...
#if VERSION_CN
INCLUDE_ASM("asm/cn/nonmatchings/main_segment/replay", replay_play);
#endif
