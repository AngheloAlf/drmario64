...
TiTexData *_getTexName(struct_watchMenu *, s32 arg1);
...
#if VERSION_CN
INCLUDE_ASM("asm/cn/nonmatchings/main_segment/main_menu", _getTexName);
#endif
...
#if VERSION_CN
INCLUDE_ASM("asm/cn/nonmatchings/main_segment/main_menu", _getKeyLvl);
#endif
