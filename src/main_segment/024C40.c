...
#if VERSION_US
INCLUDE_ASM("asm/us/nonmatchings/main_segment/024C40", func_8003CE20);
#endif

#if VERSION_US
INCLUDE_ASM("asm/us/nonmatchings/main_segment/024C40", func_8003CE5C);
#endif

#if VERSION_US
INCLUDE_ASM("asm/us/nonmatchings/main_segment/024C40", func_8003CF2C);
#endif

#if VERSION_US
INCLUDE_ASM("asm/us/nonmatchings/main_segment/024C40", func_8003CFA8);
#endif
