...
extern LwsObj D_05000D30[];
extern LwsKey D_05000D90[];
...
extern LwsObj D_050027F8[];
extern LwsKey D_05002858[];
...
extern LwsObj D_05004130[];
extern LwsKey D_05004190[];
...
extern LwsObj D_05005240[];
extern LwsKey D_050052A0[];
...
extern LwsObj D_05006328[];
extern LwsKey D_05006370[];
...
extern LwsObj D_050072B0[];
extern LwsKey D_050072F8[];
...
extern LwsObj D_05009580[];
extern LwsKey D_05009610[];
...
extern LwsObj D_0500A998[];
extern LwsKey D_0500A9B0[];
...
extern LwsObj D_0500C0B8[];
extern LwsKey D_0500C100[];
...
extern LwsObj D_05012CA0[];
extern LwsKey D_05012E80[];
...
extern LwsObj D_05014170[];
extern LwsKey D_05014188[];
...
extern LwsObj D_05015AD8[];
extern LwsKey D_05015B38[];
...
extern LwsObj D_05016D80[];
extern LwsKey D_05016DE0[];
...
extern LwsObj D_050187D8[];
extern LwsKey D_05018958[];
extern u32 D_05019218[];

Lws *D_05000000[] = {
    &D_0500563C, // ETC_LWS_INDEX_0
    &D_0500685C, // ETC_LWS_INDEX_1
    &D_0500197C, // ETC_LWS_INDEX_2
    &D_05000038, // ETC_LWS_INDEX_3
    &D_05004414, // ETC_LWS_INDEX_4
    &D_05003444, // ETC_LWS_INDEX_5
    &D_050077AC, // ETC_LWS_INDEX_6
    &D_0500A0AC, // ETC_LWS_INDEX_7
    &D_050142A0, // ETC_LWS_INDEX_8
    &D_0500AAAC, // ETC_LWS_INDEX_9
    &D_0500C544, // ETC_LWS_INDEX_10
    &D_05013954, // ETC_LWS_INDEX_11
    &D_05016158, // ETC_LWS_INDEX_12
    &D_05017400, // ETC_LWS_INDEX_13
};
static_assert(ARRAY_COUNT(D_05000000) == ETC_LWS_INDEX_MAX, "");
...
LwsObj D_05000D30[] = {
    { D_050002B0, -1, 23, 0, 0, 0, 0 },
    { D_050005D0, -1, 28, 23, 0, 0, 0 },
    { D_05000900, -1, 23, 51, 0, 0, 0 },
    { D_05000C40, -1, 27, 74, 0, 0, 0 },
};
...
LwsObj D_050027F8[] = {
    { D_05001C48, -1, 23, 0, 0, 0, 0 },
    { D_05001FB8, -1, 28, 23, 0, 0, 0 },
    { D_05002358, -1, 23, 51, 0, 0, 0 },
    { D_05002708, -1, 27, 74, 0, 0, 0 },
};
...
LwsObj D_05004130[] = {
    { D_050036A0, -1, 5, 0, 0, 0, 0 },
    { D_050039D0, -1, 5, 5, 0, 0, 0 },
    { D_05003D10, -1, 6, 10, 0, 0, 0 },
    { D_05004040, -1, 5, 16, 0, 0, 0 },
};
...
LwsObj D_05005240[] = {
    { D_050046C0, -1, 7, 0, 0, 0, 0 },
    { D_05004A40, -1, 7, 7, 0, 0, 0 },
    { D_05004DD0, -1, 8, 14, 0, 0, 0 },
    { D_05005150, -1, 7, 22, 0, 0, 0 },
};
...
LwsObj D_05006328[] = {
    { D_05005A80, -1, 14, 0, 0, 0, 0 },
    { D_05005D20, -1, 14, 14, 0, 0, 0 },
    { D_05006238, -1, 13, 28, 0, 0, 0 },
};
...
LwsObj D_050072B0[] = {
    { D_05006BE0, -1, 14, 0, 0, 0, 0 },
    { D_05006E50, -1, 14, 14, 0, 0, 0 },
    { D_050071C0, -1, 13, 28, 0, 0, 0 },
};
...
LwsObj D_05009580[] = {
    { D_05007C80, -1, 16, 0, 0, 0, 0 },  { D_050080F0, -1, 17, 16, 0, 0, 0 }, { D_050086B0, -1, 15, 33, 0, 0, 0 },
    { D_05008B30, -1, 14, 48, 0, 0, 0 }, { D_05009010, -1, 15, 62, 0, 0, 0 }, { D_05009490, -1, 15, 77, 0, 0, 0 },
};
...
LwsObj D_0500C0B8[] = {
    { D_0500B128, -1, 10, 6, 0, 0, 0 },
    { D_0500B878, -1, 8, 16, 0, 0, 0 },
    { D_0500BFC8, -1, 6, 24, 0, 0, 0 },
};
...
LwsObj D_05012CA0[] = {
    { D_0500C7F0, -1, 5, 0, 0, 0, 0 },  { D_0500CF30, -1, 5, 5, 0, 0, 0 },  { D_0500D2F8, -1, 5, 10, 0, 0, 0 },
    { D_0500DA00, -1, 5, 15, 0, 0, 0 }, { D_0500DDA0, -1, 5, 20, 0, 0, 0 }, { D_0500E520, -1, 5, 25, 0, 0, 0 },
    { D_0500E850, -1, 5, 30, 0, 0, 0 }, { D_0500EE10, -1, 5, 35, 0, 0, 0 }, { D_0500F1A0, -1, 5, 40, 0, 0, 0 },
    { D_0500F900, -1, 5, 45, 0, 0, 0 }, { D_0500FC80, -1, 5, 50, 0, 0, 0 }, { D_050103C0, -1, 5, 55, 0, 0, 0 },
    { D_05010740, -1, 5, 60, 0, 0, 0 }, { D_05010E80, -1, 5, 65, 0, 0, 0 }, { D_05011180, -1, 5, 70, 0, 0, 0 },
    { D_050117C0, -1, 5, 75, 0, 0, 0 }, { D_05011AD0, -1, 5, 80, 0, 0, 0 }, { D_05012060, -1, 5, 85, 0, 0, 0 },
    { D_05012410, -1, 4, 90, 0, 0, 0 }, { D_05012BB0, -1, 4, 94, 0, 0, 0 },
};
...
LwsObj D_05015AD8[] = {
    { D_050147E8, -1, 12, 0, 0, 0, 0 },
    { D_05014DD8, -1, 12, 12, 0, 0, 0 },
    { D_050153C8, -1, 12, 24, 0, 0, 0 },
    { D_050159E8, -1, 12, 36, 0, 0, 0 },
};
...
LwsObj D_05016D80[] = {
    { D_050166A0, -1, 12, 0, 0, 0, 0 },
    { D_05014DD8, -1, 12, 12, 0, 0, 0 },
    { D_05016C90, -1, 12, 24, 0, 0, 0 },
    { D_050159E8, -1, 12, 36, 0, 0, 0 },
};
...
LwsObj D_050187D8[] = {
    ...
    { D_0500DA00, -1, 5, 15, 0, 0, 0 }, { D_0500DDA0, -1, 5, 20, 0, 0, 0 }, { D_0500E520, -1, 5, 25, 0, 0, 0 },
    { D_0500E850, -1, 5, 30, 0, 0, 0 }, { D_0500EE10, -1, 5, 35, 0, 0, 0 }, { D_0500F1A0, -1, 5, 40, 0, 0, 0 },
    { D_0500F900, -1, 5, 45, 0, 0, 0 }, { D_05017658, -1, 5, 50, 0, 0, 0 }, { D_05017958, -1, 5, 55, 0, 0, 0 },
    { D_05017C88, -1, 5, 60, 0, 0, 0 }, { D_05017F88, -1, 5, 65, 0, 0, 0 }, { D_05018350, -1, 5, 70, 0, 0, 0 },
    { D_050186E8, -1, 5, 75, 0, 0, 0 },
};
