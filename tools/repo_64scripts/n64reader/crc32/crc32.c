/**
 * Borrowing the CRC functions from gcc/libiberty. Therefore this file is licenced under the Lesser GPL v 2.0 or later,
 * including such modifications as have been required to use it standalone.
 */
